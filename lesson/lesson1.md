...
- Храните все резюме в начале `ru.javawebinar.basejava.storage.model.storage` (без пустот в виде `null`), чтобы не перебирать каждый раз все 10_000 элементов
...
```
Схема хранения резюме в массиве ru.javawebinar.basejava.storage.model.storage (в элементах от 0 до size-1 отсутствуют null):

r1, r2, r3,..., rn, null, null,..., null
<----- size ----->
<------- ru.javawebinar.basejava.storage.model.storage.length (10000) ------->
```
